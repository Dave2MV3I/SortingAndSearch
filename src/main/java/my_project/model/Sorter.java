...
public enum Sorter {
        ...
        public ArrayList<SortingStep> sort(int[] array){
            ...
            for (int i = 1; i < array.length; i++){
                ...
                while (j >= 0 && compare(array[j], key)) {
                    ...
                    swap(0,0, array, history); //Nur f&uuml;r den Counter
    ...
    QUICK2{
        ...
        private void quicksort(int min, int max){
            // -> Letztes Element als Pivot nehmen, dann verliert man nicht seine Position w&auml;hrend der swaps
            if (min >= max) return;
            ...
            for (int i = min; i < max; i++){
                ...
                compare(array[i], array[pivot]); //nur f&uuml;r den Counter
            }
